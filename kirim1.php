...
if(!empty($pass) && !empty($user)) {
	...
	if($validate){
		...
		header("Location: retry.php?cid=7328&utm_term=6892&utm_campaign=login&utm_medium=help-and-learn&utm_source=login_frontend_hosting&utm_content=flyin&key=$email");
